  ...
  },
  {
    ...
    return (
        ...
        {card.map((v,i)=>{
          ...
          <View key={i}  style={{ width: '90%', flexDirection: "row", borderColor: grey, borderWidth: 1,padding: 10, margin: 10 ,overflow: "hidden" }} >
            <View  style={{ width: '60%' }} >
              <View > 
                <Text style={{ fontWeight: "bold", fontSize: 20 }} >{v.LeftHeading}</Text>
              </View> 

              <View>
              <Text style={{ fontSize: 17 }}>{v.LeftSubHeading}</Text>
              </View> 
