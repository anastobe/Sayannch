...
const Report = () => {
  ...
  const array2 = [
    <View style={{ paddingBottom: 30, borderColor: "#E2E2E2", borderRadius: 10, borderWidth: 1, padding: 10 }} >
    ...
    <>
      ...
      <SafeAreaView style={styles.SafeAreaView2}>
        ...
        <ScrollView>
          ...
          <View>
            <Text style={{ fontSize: 35, fontWeight: "bold", color: grey, textTransform: "uppercase", width: "90%" }} numberOfLines={1} adjustsFontSizeToFit > Report Infringement </Text>
          </View>
